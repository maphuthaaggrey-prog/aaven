      ...
      <footer className="footer">
        <div className="footer-cont" id="footer-cont">
          ...
          >
            ...
            <p className="send-message">WORK WITH US</p>
            ...
            <p className="sub-text">Whether you need a new website, a fresh design, or support for your current platform, we’re ready to help!</p>
            <fieldset>
