...
const WhoAreWe = () => {
    return ( 
        ...
        <div className="container">
            ...
            <p className="header" style={{marginTop: '2em'}}>MEET THE MINDS</p>
            <div className="team">
