            ...
            <div className="navbar">
                ...
                <div>
                    ...
                    <ul className={menuOpen ? "nav ul open" : ""}>
                        ...
                        <li onClick={toggleMenu}><a href="#who-are-we">WHO ARE WE</a></li>
                        <li onClick={toggleMenu}><a href="#what-we-do">WHAT WE DO</a></li>
                        <li onClick={toggleMenu}><a href="#work-with-us">WORK WITH US</a></li>
                    </ul>
                </nav>
